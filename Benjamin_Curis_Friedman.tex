...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeSubheadingEducation
      ...
      {Covering supervised learning, deep learning, unsupervised-learning, and ML engineering practices.}{  100\% Grade}
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      {McGill University}{Montreal, QC}
      \resumeItemListStart
        \resumeItem{Training a YOLO model to detect targets autonomously.}
    \resumeItemListEnd
